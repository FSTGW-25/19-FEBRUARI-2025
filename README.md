...
<body>
  <div class="title-box">26 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 3.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Campfire.mp3');
    ...
    const fullMessage = `"Hidup ini bukan sekadar tentang seberapa cepat mencapai tujuan, tapi tentang bagaimana menikmati setiap langkah dalam perjalanan 🌼. Kadang jalan yang ditempuh terasa lambat, tapi bukan berarti tidak ada kemajuan 🛤️🌱. Setiap pengalaman, baik suka maupun duka, membentuk diri menjadi lebih kuat dan bijaksana 💪🧠. Jangan terburu-buru untuk sampai di garis akhir ⏳, karena setiap momen yang dijalani adalah bagian berharga dari perjalanan 🌈. Percayalah, semua akan indah pada waktunya 🤍🌸🌼."`;
